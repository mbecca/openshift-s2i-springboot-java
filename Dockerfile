# s2i-springboot : 19/07/2018
#
# springboot-java
#
FROM openshift/base-centos7
MAINTAINER Matías Beccaria mbecca@mecon.gov.ar
...
LABEL io.k8s.description="Platform for building Spring Boot applications with gradle" \
      ...
      io.openshift.tags="Java,Springboot,builder, gradle"
...
# Set the location of the gradle bin directories on search path
